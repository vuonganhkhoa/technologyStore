                                        ...
                                        <div class="item-inner">
                                            ...
                                            <div class="des-container">
                                                ...
                                                <div class="price-box">
                                                    ...
                                                    <p class="old-price price">
                                                        <span class="price-label">Giá: </span>
                                                        <span class="old-price"><?php echo e(number_format($sp_moi->GiaSP)); ?></span>
                                                    </p>
                                                    <?php else: ?>
                                                    <p class="price">
                                                        <span class="price-label">Giá: </span>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="image-cat">
                                    <a href="<?php echo e(route('tintuc_chitiet', $tin->idTin)); ?>"><img alt="Electronic" src="clientassets/upload/tintuc/<?php echo e($tin->urlHinhTin); ?>"></a>
                                </div>
                            </div>
                            <div class="col-xs-6">
