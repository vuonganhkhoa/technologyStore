            	...
            	<div class="row">
                	...
                	<div class="col-sm-7">
                    	<div class="blog-detail blog-list">
                        	<div class="blog-image"><img src="clientassets/upload/tintuc/<?php echo e($tin->urlHinhTin); ?>" class="img-responsive" alt=""></div>

                            <div class="item">
                                <div class="item-inner">
                                    <h2 class="product-name"><a title="" href="#"><?php echo e($tin->TieuDe); ?></a></h2>
