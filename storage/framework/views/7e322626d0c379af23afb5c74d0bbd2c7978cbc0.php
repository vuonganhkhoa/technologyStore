...
<html lang="en">
  ...
  <body>
        ...
        <?php echo $__env->make('clientStore.layout.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-body">
                ...
                <p>Bạn đã thêm <strong class="themgiohang"><?php $__currentLoopData = $content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo e($sp->name. ' '); ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></strong> vào giỏ hàng.</p>
                
                <p><a href="<?php echo e(route('giohang')); ?>">Xem giỏ hàng</a></p>
              </div>
        ...
        <?php echo $__env->make('clientStore.layout.footer', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        ...
        <?php if(!empty(Session::get('error')) && Session::get('error') == 5): ?>
        <script>
            $(function() {
                $('#myModal').modal('show');
            });
