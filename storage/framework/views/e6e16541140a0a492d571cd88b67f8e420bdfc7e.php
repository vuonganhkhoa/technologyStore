                        ...
                        <div class="col-md-8">
                            ...
                            <div class="card">
                                <div class="card-header" data-background-color="purple">
                                    <h4 class="title">Cập nhật hình sản phẩm</h4>
                                </div>
                                <div class="card-content">

                                    <form method="POST" action="admin/hinhsanpham/sua/<?php echo e($hinhsanpham->idHinh); ?>" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="SanPham" id="LoaiTin">
                                                      <?php $__currentLoopData = $sanpham; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($sp->idSP); ?>" <?php if($hinhsanpham->idSP == $sp->idSP): ?> <?php echo e('selected'); ?> <?php endif; ?>><?php echo e($sp->TenSP); ?></option>
                                                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                            </div>
