                        ...
                        <div class="col-md-8">
                            ...
                            <div class="card">
                                <div class="card-header" data-background-color="purple">
                                    <h4 class="title">Cập nhật loại sản phẩm</h4>
                                </div>
                                <div class="card-content">
                                    <form method="POST" action="admin/loaisanpham/sua/<?php echo e($loaisp->idLoaiSP); ?>">
                                        <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Tên loại sản phẩm</label>
                                                    <input type="text" class="form-control" name="tenLoaiSP" value="<?php echo e($loaisp->TenLoaiSP); ?>">
                                                </div>
                                            </div>
                                        </div>
