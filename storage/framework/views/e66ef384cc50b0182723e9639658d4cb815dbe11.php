...
<head>
    <meta charset="utf-8" />
    <base href="<?php echo e(asset('')); ?>"> <!--  Trở lại thư mục gốc (css,js)  -->
...
<body>
    ...
    -->
        ...
        <div class="main-panel">
            <!-- Header -->
            <?php echo $__env->make('adminDashboard.layout.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            ...
            <!-- Footer -->
            <?php echo $__env->make('adminDashboard.layout.footer', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
