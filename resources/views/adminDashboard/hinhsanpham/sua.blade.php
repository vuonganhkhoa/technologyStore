                        ...
                        <div class="col-md-8">
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <form method="POST" action="admin/hinhsanpham/sua/{{$hinhsanpham->idHinh}}" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="SanPham" id="LoaiTin">
                                                      @foreach($sanpham as $sp)
                                                        <option value="{{$sp->idSP}}" @if($hinhsanpham->idSP == $sp->idSP) {{'selected'}} @endif>{{$sp->TenSP}}</option>
                                                      @endforeach
                                                    </select>
                                                </div>
                                            </div>
